...
ffmpeg -f alsa -ac 2 -i pulse -f x11grab -s $REZ -r $FPS -i :0.0+0,0 -vcodec $CODEC -acodec pcm_s16le -ar 48000 -s $REZ -y -qscale 1 $VPATH/$TIME.$OFILE
