...
gst-launch-0.10 avimux name=mux ! filesink  location=\"$VPATH/$TIME.$OFILE\" uridecodebin uri="$URI" name=demux demux. ! videoscale ! videorate ! ffmpegcolorspace ! video/x-raw-yuv,width=$WIDTH,height=$HEIGHT,framerate=$FPS ! $ENC ! queue ! mux.video_0 demux. ! progressreport ! audioconvert ! audiorate ! audioresample ! 'audio/x-raw-int,rate=44100,cahannels=2' ! queue ! mux.audio_0
