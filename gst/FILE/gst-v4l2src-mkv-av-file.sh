...
gst-launch -e -v $MUX name=mux ! filesink location=$VPATH/$TIME.$OFILE v4l2src device=$VDEVIN ! jpegenc ! image/jpeg,width=1280,height=720,framerate=30/1 ! mux.video_0 jackaudiosrc ! audioconvert ! queue ! audio/x-raw-int,depth=16,width=16 ! mux.audio_0
