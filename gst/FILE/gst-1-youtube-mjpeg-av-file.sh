...
gst-launch-1.0 avimux name=mux ! filesink location=\"$VPATH/$OFILE\" uridecodebin uri=$URI name=demux demux. ! videoscale ! videoconvert ! videorate ! video/x-raw,framerate=30/1 ! jpegenc ! queue ! mux.video_0 demux. ! progressreport ! audioconvert ! audiorate ! audioresample ! 'audio/x-raw,rate=48000,channels=2' ! queue ! mux.audio_0
